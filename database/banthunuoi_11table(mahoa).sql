...
--
-- Serveur: localhost
-- Généré le : Mar 27 Novembre 2012 à 18:06
...
--
-- Base de données: `banthunuoi`
--

-- --------------------------------------------------------

--
-- Structure de la table `banggia`
--
...
--
-- Structure de la table `cacloaithunuoi`
--
...
--
-- Contenu de la table `cacloaithunuoi`
--
...
--
-- Structure de la table `chitietthunuoi`
--
...
--
-- Contenu de la table `chitietthunuoi`
--
...
--
-- Structure de la table `donhangchitiet`
--
...
--
-- Contenu de la table `donhangchitiet`
--
...
(1, 'Võ Văn Nhiên', 1, '101 Đỗ Xuân Hợp Q9 TPHCM', '012687444', 'nhien', '56397d952c6ba7d29e04e3da5625885cd6d24162', '1', 'nhien600@yahoo.com', '1975-09-22', '123'),
(2, 'Lê Duy Anh', 1, '102 Đỗ Xuân Hợp Q9 TPHCM', '096887410', 'luan', '202cb962ac59075b964b07152d234b70', '0', 'luan@gmail.com', '1980-05-08', '123'),
(3, 'Lưu Gia Thoại', 1, '103 Đỗ Xuân Hợp Q9 TPHCM', '069871632', 'thoai', '123', '0', 'thoai@gmail.com', '1982-10-20', '123'),
(4, 'Trần Ngọc Dân', 1, '104 Đỗ Xuân Hợp Q9 TPHCM', '098756355', 'dan', '123', '0', 'dan@yahoo.com', '1977-10-05', '123'),
...
--
-- Structure de la table `loaithunuoi`
--
...
--
-- Contenu de la table `loaithunuoi`
--
...
--
-- Contenu de la table `thunuoi`
--

INSERT INTO `thunuoi` (`mathunuoi`, `tenthunuoi`, `maloaithunuoi`, `maloaithu`, `mota`, `soluong`, `dongia`, `hinh`, `ngaynhap`) VALUES
('CH03', 'Chó sư tử lùn tây tạng', 'CH', 'C', 'ShihTzu: chó sư tử lùn tây tạng\r\nXuất xứ: Tây tạng\r\nMàu sắc: đa sắc( thường là 3 màu)\r\nTrọng lượng: 3 kg – 4,5 kg\r\nTính cách: chó cảnh giữ nhà, khôn, cần có bạn.\r\n', 50, 500000, 'cho3.jpg', '2012-10-15'),
('CH05', 'Chó Jack Russel', 'CH', 'C', 'Jack Russel\r\nXuất xứ: Devon ( Anh )\r\nMàu sắc: đen và nâu nhạt\r\nTrọng lượng: 3 kg – 4 kg\r\nTính cách: năng động là kẻ săn chuột cừ khôi, giống chó săn đa năng luôn lanh chanh tràn đầy sức sống', 20, 1000000, 'cho5.jpg', '2012-10-12'),
('CH01', 'Chó Siberian Husky', 'CH', 'C', 'Siberian Husky: chó Eskimô vùng Xibêri\r\nXuất xứ: Sibêri\r\nMàu sắc: đa sắc( trắng đen, nâu trắng......)\r\nTrọng lượng: 24,4 kg – 27,2 kg\r\nTính cách: chịu đựng giỏi, hiếu động, thân thiện, dũng cảm.\r\nĐặc biệt: giữ nhà, làm việc.\r\n', 80, 5000000, 'cho1.jpg', '2012-10-09'),
('CH02', 'Chó Pomeranian ', 'CH', 'C', 'Chó phóc lông dài \r\nXuất xứ: Đức\r\nMàu sắc: trắng, kem, cam, xám, đen vàng\r\nTrọng lượng: 1,5 kg – 2,5 kg\r\nTính cách: can đảm, lanh lợi, dễ thương\r\n', 30, 3000000, 'cho2.jpg', '2012-10-16'),
('CH04', 'Chó Beagle', 'CH', 'C', 'Chó Beagle\r\nXuất xứ: Anh\r\nMàu sắc: đen trắng và nâu nhạt\r\nTrọng lượng: 4 kg – 7 kg\r\nTính cách: thích nghi hoàn cảnh nhanh.', 60, 2000000, 'cho4.jpg', '2012-10-03'),
('CH06', 'Chó ChiHuaHua', 'CH', 'C', 'Chiều cao: 6-9 inches (15-23 cm.) \r\nCân nặng: 2-6 pounds (1-3 kg.) \r\nNơi sống: Trong chuồng', 100, 500000, 'chochihuahua.jpg', '2012-10-10'),
('CA01', 'Cá thủy sinh Ali ', 'CA', 'A', 'Cá thủy sinh Ali vàng bé thường được nuôi trong bể làm kiểng \r\nMàu sắc: vàng\r\nXuất sứ: Việt Nam', 200, 100000, 'ca1.jpg', '2012-10-01'),
('CA02', 'Cá Đầu Bò', 'CA', 'A', 'Cá Đầu Bò được nuôi trong hồ kiếng làm kiểng chơi \r\nMàu sắc: Đen\r\nXuất Xứ: Chưa bik nguồn gốc ', 100, 80000, 'ca2.jpg', '2012-10-30'),
('CA03', 'Cá cảnh Kole tang ', 'CA', 'A', 'Cá cảnh Kole tang cá đẹp long lanh nuôi cho đẹp \r\nXuất xứ: Campuchia', 50, 100000, 'ca3.jpg', '2012-10-25'),
('CA04', 'Cá Hoàng Bảo Yến', 'CA', 'A', 'Cá Hoàng Bảo Yến có thân trắng xám vành đen thức ăn chủ yếu là cám\r\nMàu sắc Trắng xám\r\nXuất xứ: VN', 300, 120000, 'ca4.jpg', '2012-10-09'),
('CA05', 'Cá Thanh Long vây Hồng', 'CA', 'A', 'Cá Thanh Long vây Hồng là loại cá hiện nay được rất nhìu đại gia ưa chuộng vì vẽ đẹp của nó\r\nXuất xứ: ko rõ\r\nMàu sắc : đa màu sắc \r\n', 500, 10000000, 'ca5.jpg', '2012-10-31'),
('ME01', 'Mèo vàng ', 'ME', 'M', 'Mèo vàng bé tý nhỏ xinh \r\nMàu sắc: vàng khè', 10, 100000, 'meo1.jpg', '2012-10-17'),
('ME02', 'Mèo trắng sọc đen', 'ME', 'M', 'Mèo trắng sọc đen nhìn thấy mà cưng\r\nMàu sắc: trắng đen\r\nXuất xứ: VN', 70, 500000, 'meo2.jpg', '2012-10-25'),
('ME03', 'Mèo tam thể ', 'ME', 'M', 'Mèo tam thể  tráng vàng thường được nuôi trong nhà với tài bắt chuột cực giỏi\r\nXuất xứ: VN', 150, 80000, 'meo3.jpg', '2012-07-10'),
('ME04', 'Mèo trắng tiểu thư', 'ME', 'M', 'Mèo trắng tiểu thư \r\nXuất xứ: Đông-Ti-Mo\r\nMàu sắc: Trắng bóc', 500, 500000, 'meo4.jpg', '2012-10-26'),
('ME05', ' Mèo bá đạo ', 'ME', 'M', 'Mèo bá đạo\r\nMàu sắc: Trắng\r\nXuất xứ: Lào ', 90, 700000, 'meo5.jpg', '2012-10-01'),
('CHU01', 'Chuột Dominant Spot Winterwhite', 'CHU', 'U', 'Chuột Dominant Spot Winterwhite \r\nXuất xứ :Thailand được các bạn trẻ ngày nay nuôi nhìu trong nhà\r\nMàu sắc: Vàng trắng \r\nTính cách: hiền lành', 300, 40000, 'chuot1.jpg', '2012-09-04'),
('CHU02', 'Chuột Golden mắt đen ', 'CHU', 'U', 'Chuột Golden mắt đen  thức ăn chủ yếu là món rau xanh các loại ngũ cốc, ngô, mè, cà rốt\r\nXuất xứ: Tháiland\r\nTính cách: vui vẽ \r\n\r\n', 300, 80000, 'chuot2.jpg', '2012-08-07'),
('CHU03', 'Chuột Whiteface Roborovski ', 'CHU', 'U', 'Chuột Whiteface Roborovski nuôi trong lồng kính và được chắm sóc kỹ càng\r\nMàu sắc: xám trắng\r\nThức ăn chính: rau, ngũ cốc', 100, 90000, 'chuot3.jpg', '2012-10-09'),
('CHU04', 'Chuột Beige Winterwhite', 'CHU', 'U', 'Chuột Beige Winterwhite đặc biệt nhất là có đôi mắt màu đỏ\r\nMàu sắc: vàng hoe\r\nKích cỡ : 4-5cm\r\nTính cách: Hiền ko dzữ', 20, 110000, 'chuot4.jpg', '2012-04-02'),
('CHU05', 'Chuột Lilac Winterwhite', 'CHU', 'U', 'Chuột Lilac Winterwhite  nhỏ nhắn đáng yêu  thưởng được nhắc đến trong truyện cổ tích với cái tên " chuột LiLac"\r\nMàu sắc : Trắng xám', 30, 70000, 'chuot5.jpg', '2012-06-11'),
('CH07', 'Chóhuahua', 'CH', 'C', 'chó chi hua hua đẹp  \r\nTrọng lượng: 1,5 kg – 2,5 kg\r\nTính cách: vui vẽ, lanh lợi, dễ thương\r\nMàu sắc: đa màu ', 152, 70000, 'cho7.jpg', '2012-10-10'),
('CH08', 'Chó xù', 'CH', 'C', 'Chó xù lù xù lù \r\nMàu sắc: trắng\r\nTính cách: lanh lợi, gậm xương', 598, 135000, 'cho8.jpg', '2012-04-10'),
('CH09', 'Chó đia hia', 'CH', 'C', 'Chó đia hia lìa hia hia tai to \r\nMàu sắc: Trắng đen\r\nTính cách: hiền lành , nghe lời chủ', 350, 121500, 'cho9.jpg', '2012-10-29'),
('CHU06', 'Chuột hamter trắng', 'CHU', 'U', 'Chuột hamter trắng cà lắng ắng ắng\r\nKích cỡ: 3-4cm\r\nNơi sống: lồng kính\r\nXuất xứ: VN', 350, 350000, 'chuot6.jpg', '0000-00-00'),
('CHU07', 'Chuột vàng', 'CHU', 'U', 'Chuột vàng khè \r\nMàu sắc: Vàng, trắng\r\nKích cỡ: 2-3cm\r\nNơi sông: lồng kính', 175, 250000, 'chuot7.jpg', '2012-10-31'),
('CHU08', 'Chuột chấu', 'CHU', 'U', 'Chuột Chấu cà lấu ấu ấu \r\nThức ăn chính: chấu, rau , củ, quả\r\nTính tình: hiền, nhát\r\nXuất xứ: Trung Quốc', 250, 30000, 'chuot8.jpg', '2012-08-07'),
('CHU09', 'Chuột đen ', 'CHU', 'U', 'Chuột đen cà ren en en\r\nMàu sắc:Đen\r\nXuất xứ: Tàu khựa', 300, 25000, 'chuot9.jpg', '2012-10-07'),
('CHU10', 'Hamter vàng', 'CHU', 'U', 'Hamter vàng \r\nNơi sống: Lồng kính\r\nKích cỡ: 4-5cm\r\nThức ăn: Gạo, chấu...\r\n\r\n', 250, 15000, 'chuot10.jpg', '2012-10-02'),
('ME06', 'Mèo trắng đen', 'ME', 'M', 'Mèo trắng đen  \r\nMàu sắc: Đen trắng\r\nTính cách: hiền, bắt chuột giỏi\r\nThức ăn: Cá, mỡ\r\n', 50, 150000, 'meo6.jpg', '0000-00-00'),
('ME07', 'Mèo tiểu thư điệu', 'ME', 'M', 'Mèo tiểu thư điệu cho mấy gái điệu', 136, 256800, 'meo7.jpg', '2012-10-02'),
('ME08', 'Mèo xám', 'ME', 'M', 'Mèo Xám cà lám ám ám', 158, 125000, 'meo8.jpg', '2012-10-18'),
('ME09', 'Mèo tam thể vàng', 'ME', 'M', 'Mèo tam thể vàng àn cà làn àn àn', 25, 98999, 'meo9.jpg', '2012-10-03'),
('ME10', 'Mèo trắng tinh thể', 'ME', 'M', 'Mèo trắng tinh thể', 32, 354444, 'meo10.jpg', '2012-10-10'),
('CA06', 'Cá Cichlids châu Phi ', 'CA', 'A', 'Cá Cichlids khi lớn lên thường có chiều dài thân từ 15 đến 18cm, sống trong nước ngọt và dễ dàng nuôi trong bể cá cảnh.', 235, 35000, 'ca6.jpg', '2012-10-22');

-- --------------------------------------------------------

--
-- Structure de la table `tin`
--

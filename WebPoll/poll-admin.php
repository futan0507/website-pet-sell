...
?>
  <tr>
    ...
    <td width="58" align="left" style="border-bottom:1px solid #DFE4E8"><a href='#' onClick='pass=confirm("Are you sure you want to delete it?",""); if (pass) window.location="poll-admin.php?ac=del_poll&qid=<?php echo $POLL["ID"]; ?>";'><strong style='color:red'>DELETE</strong></a></td>
  </tr>
  <?php
	};
?>
